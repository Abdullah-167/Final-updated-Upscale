...
const DatawizzPage = () => {
    ...
    const images = [
        "/projects/web/datawizz/datawizz2.webp",
        "/projects/web/datawizz/datawizz3.webp",
        "/projects/web/datawizz/datawizz4.webp",
        "/projects/web/datawizz/datawizz5.webp",
        "/projects/web/datawizz/datawizz6.webp",
        "/projects/web/datawizz/datawizz7.jpeg",
        "/projects/web/datawizz/datawizz8.webp",
        "/projects/web/datawizz/datawizz9.webp",
        "/projects/web/datawizz/datawizz10.webp"
    ];
        ...
        <section className='max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12 lg:pb-16 pt-20 sm:pt-24 lg:pt-28'>
            ...
            <div className="mb-8 sm:mb-12 lg:mb-16">
                <h1 className="text-[32px] sm:text-[40px] lg:text-[51px] leading-[1.2] sm:leading-[1.3] lg:leading-[60px] pb-4 sm:pb-6 lg:pb-10 font-bold text-gray-900">
                    Building the brand, website, and launch system for a $12.5M seed AI company.
                </h1>
                <p className="text-[16px] sm:text-[17px] lg:text-[18px] text-gray-700 max-w-3xl leading-relaxed">
                    We partnered with Datawizz for 18+ months across brand identity, investor materials, marketing assets, launch videos, product pages, and a highly interactive Framer website built for speed, clarity, and scale.
                </p>
            </div>

            {/* Stats & Testimonial Grid - Exact Droxy Style */}
            <div className=" bg-gradient-to-r from-[#faf7ff] to-[#faf7ff] p-5 flex justify-between gap-2 mb-5">
                ...
                <div className="max-w-[500px] bg-white p-5 rounded-xl">
                    <p className="text-[15px] sm:text-[16px] lg:text-[18px] text-gray-700 leading-relaxed mb-10">
                       "Abdullah is a phenomenal designer. He and the Upscale Alliacne team have shaped all the visuals for Datawizz, from brand and marketing collateral to our website.”
                    </p>
                    <div className="flex items-center gap-3">
                        <div className="flex-shrink-0">
                            <Image
                                className="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover"
                                src={"/projects/web/datawizz/avator.avif"}
                                alt={"Ali Elzein"}
                                width={48}
                                height={48}
                            />
            ...
            <div className="mb-8 sm:mb-12 lg:mb-16">
                <div className="relative rounded-2xl sm:rounded-[30px] overflow-hidden shadow-lg bg-black">
                    <video
                        ...
                        playsInline
                        muted
                        src="/projects/web/datawizz/DATAWIZZ_CASE_STUDY_web.mp4"
                    ...
                    >
                        <div className="relative rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 group">
                            <Image
                                ...
                                src={src}
                                alt={`Datawizz project image ${index + 1}`}
                                width={1000}
                                height={1000}
                                priority={index < 3}
                            />
