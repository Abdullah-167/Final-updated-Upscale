...
const DroxyPage = () => {
    ...
    const images = [
        "/projects/web/droxy/droxy1.webp",
        "/projects/web/droxy/droxy2.avif",
        "/projects/web/droxy/droxy3.webp",
        "/projects/web/droxy/droxy4.webp",
        "/projects/web/droxy/droxy5.webp",
        "/projects/web/droxy/droxy6.webp",
        "/projects/web/droxy/droxy7.webp",
        "/projects/web/droxy/droxy8.webp",
        "/projects/web/droxy/droxy9.webp"
    ];
        ...
        <section className='max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12 lg:pb-16 pt-20 sm:pt-24 lg:pt-28'>
            ...
            <div className="mb-8 sm:mb-12 lg:mb-16">
                <h1 className="text-[32px] sm:text-[40px] lg:text-[51px] leading-[1.2] sm:leading-[1.3] lg:leading-[60px] pb-4 sm:pb-6 lg:pb-10 font-bold text-gray-900">
                    Reinvented DroxyAI with a bold brand and dynamic website presence.
                </h1>
                <p className="text-[16px] sm:text-[17px] lg:text-[18px] text-gray-700 max-w-3xl leading-relaxed">
                    With a clear vision to enhance communication across multiple channels, Droxy sought our expertise to create a professional brand and a modern website that would showcase their transformative technology.
                </p>
            </div>
                ...
                <div className="max-w-[500px] bg-white p-5 rounded-xl">
                    <div className="mb-4">
                        <Image
                            ...
                            src={"/projects/web/droxy/droxylogo.avif"}
                            alt={"Droxy Logo"}
                            width={120}
                            height={30}
                        />
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex-shrink-0">
                            <Image
                                ...
                                src={"/projects/web/droxy/droxyavator.avif"}
                                alt={"Ali Elzein"}
                                width={48}
                                height={48}
                            />
            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-6 mb-8 sm:mb-12 lg:mb-16">
                <div className="relative rounded-xl overflow-hidden shadow-lg bg-black w-full">
                    <video
                        ...
                        playsInline
                        muted
                        src="/projects/web/droxy/droxyweb.mp4"
                ...
                <div className="relative rounded-xl overflow-hidden shadow-lg bg-black w-full">
                    <video
                        ...
                        playsInline
                        muted
                        src="/projects/web/droxy/droxyweb2.mp4"
                        className="w-full h-auto object-cover"
                    />
                </div>
                <div className="relative rounded-xl overflow-hidden shadow-lg bg-black w-full">
                    <video
                        ...
                        playsInline
                        muted
                        src="/projects/web/droxy/droxyweb3.mp4"
                        className="w-full h-auto object-cover"
                    />
                </div>
            </div>
