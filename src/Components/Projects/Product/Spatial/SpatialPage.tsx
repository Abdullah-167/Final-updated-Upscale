...
const SpatialPage = () => {
    ...
    const images = [
        "/projects/web/spatial/spatial1.webp",
        "/projects/web/spatial/spatial2.webp",
        "/projects/web/spatial/spatial3.webp",
        "/projects/web/spatial/spatial4.webp",
        "/projects/web/spatial/spatial5.webp",
        "/projects/web/spatial/spatial6.webp",
        "/projects/web/spatial/spatial7.webp",
        "/projects/web/spatial/spatial8.webp",
        "/projects/web/spatial/spatial9.webp",
        "/projects/web/spatial/spatial10.webp",
        "/projects/web/spatial/spatial11.webp",
        "/projects/web/spatial/spatial12.webp",
        "/projects/web/spatial/spatial13.jpeg",
        "/projects/web/spatial/spatial14.webp",
        "/projects/web/spatial/spatial15.webp",
        "/projects/web/spatial/spatial16.webp"
    ];
        ...
        <section className='max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12 lg:pb-16 pt-20 sm:pt-24 lg:pt-28'>
            ...
            <div className="mb-8 sm:mb-12 lg:mb-16">
                <h1 className="text-[32px] sm:text-[40px] lg:text-[51px] leading-[1.2] sm:leading-[1.3] lg:leading-[60px] pb-4 sm:pb-6 lg:pb-10 font-bold text-gray-900">
                    A 4-week brand and website refresh for Spatial's next product launch
                </h1>
                <p className="text-[16px] sm:text-[17px] lg:text-[18px] text-gray-700 max-w-3xl leading-relaxed">
                    Spatial brought us in as they were preparing for a major spatial computing push, including Apple Vision Pro experiences. We helped refresh their visual language, redesign key website pages, and launch a new product landing page in Webflow within 4 weeks.
                </p>
            </div>
                ...
                <div className="w-full">
                    <div className="mb-2 bg-white p-4 sm:p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 border border-gray-100 h-auto">
                        ...
                        <p className="text-sm sm:text-base text-gray-600">
                            To launch the new Framer website
                        </p>
                    </div>
                    <div className="mb-2 bg-white p-4 sm:p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 border border-gray-100 h-auto">
                        <h3 className="text-[28px] sm:text-[32px] lg:text-[35px] font-bold text-gray-900">
                        ...
                        <p className="text-sm sm:text-base text-gray-600">
                            Secured by Spatial to create a VisionOS dedicated platform
                        </p>
                    </div>
                ...
                <div className="max-w-[500px] bg-white p-5 rounded-xl">
                    <div className="mb-10">
                        <Image
                            ...
                            src={"/projects/web/spatial/logo.avif"}
                            alt={"Droxy Logo"}
                            width={120}
                            height={30}
                        />
                    </div>
                    <p className="text-[15px] sm:text-[16px] lg:text-[18px] text-gray-700 leading-relaxed mb-10">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex-shrink-0">
                            <Image
                                ...
                                src={"/projects/web/spatial/avator.avif"}
                                alt={"Ali Elzein"}
                                width={48}
                                height={48}
                            />
            ...
            {/* Video Section */}
            <div className="mb-8 sm:mb-12 lg:mb-16">
                <div className="relative rounded-2xl sm:rounded-[30px] overflow-hidden shadow-lg bg-black">
                    <video
                        ref={videoRef}
                        loop
                        playsInline
                        muted
                        src="/projects/web/spatial/spatialvid.mp4"
            ...
            <div className="mb-8 sm:mb-12 lg:mb-16">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                    <div>
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-4 text-gray-400">Before</h2>
                        <div className="relative rounded-xl overflow-hidden shadow-lg group cursor-pointer" onClick={() => openLightbox(0)}>
                            <Image
                                className="w-full h-auto object-cover hover:scale-105 transition-transform duration-500"
                                src={"/projects/web/spatial/spatial2.webp"}
                                alt={"Before"}
                                width={1000}
                                height={1000}
                            />
                    ...
                    <div>
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-4 text-green-500">After</h2>
                        <div className="relative rounded-xl overflow-hidden shadow-lg group cursor-pointer" onClick={() => openLightbox(1)}>
                            <Image
                                className="w-full h-auto object-cover hover:scale-105 transition-transform duration-500"
                                src={"/projects/web/spatial/spatial3.webp"}
                                alt={"After"}
                                width={1000}
                                height={1000}
                            />
                    ...
                    >
                        <div className="relative rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 group">
                            <Image
                                ...
                                src={src}
                                alt={`Spatial project image ${index + 1}`}
                                width={1000}
                                height={1000}
                                priority={index < 3}
                            />
