...
const NextPage = () => {
    ...
    const images = [
        "/projects/web/n3xt/n3xt9.webp",
        "/projects/web/n3xt/n3xt8.webp",
        "/projects/web/n3xt/n3xt5.png",
        "/projects/web/n3xt/n3xt3.webp",
        "/projects/web/n3xt/n3ext2.png"
    ];
    ...
    return (
        <section className='max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12 lg:pb-16 pt-20 sm:pt-24 lg:pt-28'>
            ...
            <div className="mb-8 sm:mb-12 lg:mb-16">
                ...
                <p className="text-[16px] sm:text-[17px] lg:text-[18px] text-gray-700 max-w-4xl leading-relaxed pb-4 sm:pb-5">
                    We helped shape the product and digital presence for N3XT, supporting an 18+ month engagement across brand, product, and web.
                </p>
                <p className="text-[16px] sm:text-[17px] lg:text-[18px] text-gray-700 max-w-4xl leading-relaxed">
            ...
            <div className=" bg-gradient-to-r from-[#faf7ff] to-[#faf7ff] p-5 flex justify-between gap-2 mb-5">
                ...
                <div className="max-w-[500px] bg-white p-5 rounded-xl">
                    <div className="mb-4 w-[100px] sm:w-[90px] h-[30px] sm:h-[36px] overflow-hidden flex items-center justify-center">
                        <Image
                            className="min-w-full min-h-full object-cover scale-[1.7]"
                            src={"/projects/web/n3xt/n3xtlogo.avif"}
                            alt={"N3XT Logo"}
                            width={120}
                            height={36}
                            style={{
                    ...
                    <p className="text-[15px] sm:text-[16px] lg:text-[18px] text-gray-700 leading-relaxed mb-6">
                        "I was impressed with their great outputs and wonderful design outcomes! Excellent project management capability, centralized in one person who orchestrates the projects' tasks and aligns the efforts to the needs. Very able to switch priorities on the fly."                    </p>
                    <div className="flex items-center gap-3">
                        <div className="flex-shrink-0">
                            <Image
                                className="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover"
                                src={"/projects/web/n3xt/avator.avif"}
                                alt={"Ali Elzein"}
                                width={48}
                                height={48}
                            />
            ...
            <div className="mb-8 sm:mb-12 lg:mb-16">
                <div className="relative rounded-2xl sm:rounded-[30px] overflow-hidden shadow-lg bg-black">
                    <video
                        ...
                        playsInline
                        muted
                        src="/projects/web/n3xt/nextvid.mp4"
                    ...
                    >
                        <div className="relative rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 group">
                            <Image
                                ...
                                src={src}
                                alt={`N3XT project image ${index + 1}`}
                                width={1000}
                                height={1000}
                                priority={index < 3}
                            />
