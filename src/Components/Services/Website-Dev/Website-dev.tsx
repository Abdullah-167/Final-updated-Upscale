        ...
        <div className="flex items-center max-w-[1200px] mx-auto relative flex-wrap lg:flex-nowrap">
          <div className="gap-6">
            <p className="font-[family-name:var(--font-body)] text-sm md:text-lg pb-7 text-white/80">
              You've seen what great websites can do, so now…
            </p>
            ...
            <p className="font-[family-name:var(--font-body)] text-white/90 text-lg md:text-xl max-w-2xl">
              Let's create a website that looks premium, performs flawlessly, and converts visitors into customers.
            </p>
          </div>
...
const services = [
  {
    ...
    items: ["UI/UX Design", "Wireframing", "Prototyping", "Design Systems", "Brand Integration"],
  },
  {
    title: "Frontend Development",
    description: "Fast, responsive websites with modern frameworks",
  ...
  },
  {
    ...
    items: ["Node.js/Express", "API Development", "Database Design", "Authentication", "Server Management"],
  },
  {
    title: "CMS Solutions",
    description: "Easy-to-manage content management systems",
    icon: <Globe className="w-6 h-6" />,
    items: ["WordPress", "Shopify", "Headless CMS", "Custom CMS", "E-commerce"],
  },
];
...
const benefits = [
  {
    ...
    description: "Optimized websites loading in under 2 seconds",
...
const packages = [
  {
    ...
    bestFor: "Startups and local businesses",
  },
  {
    ...
    bestFor: "Growing companies and brands",
    popular: true,
  },
  {
...
const process = [
  { step: 1, title: "Discovery", description: "Understanding your goals", duration: "1 Week" },
  { step: 2, title: "Design", description: "Creating beautiful layouts", duration: "2 Weeks" },
  { step: 3, title: "Development", description: "Building with code", duration: "3-4 Weeks" },
  { step: 4, title: "Testing", description: "Quality assurance", duration: "1 Week" },
  { step: 5, title: "Launch", description: "Going live", duration: "1 Week" },
];

const techStack = [
  { category: "Frontend", items: ["Next.js 14", "React", "TypeScript", "Tailwind CSS", "Framer Motion"] },
  { category: "Backend", items: ["Node.js", "Express", "MongoDB", "PostgreSQL", "Firebase"] },
  { category: "CMS", items: ["WordPress", "Shopify", "Sanity", "Contentful", "Strapi"] },
  { category: "Tools", items: ["Git/GitHub", "Vercel", "AWS", "Figma", "Adobe Suite"] },
];
...
const faqs = [
  {
    ...
    answer: "A typical website takes 4-8 weeks from discovery to launch, depending on complexity. Simple websites can be ready in 4 weeks, while complex e-commerce or custom applications may take 8-12 weeks.",
  },
  {
    question: "Do you offer website maintenance?",
    answer: "Yes! We offer ongoing maintenance packages that include security updates, performance monitoring, content updates, and technical support to keep your website running smoothly.",
  },
  {
    question: "Will my website be mobile-friendly?",
    answer: "Absolutely. We build all websites with a mobile-first approach, ensuring perfect display and functionality across all devices—desktop, tablet, and smartphone.",
  },
  {
    question: "Can you redesign my existing website?",
    answer: "Yes! We specialize in website redesigns that improve performance, user experience, and conversion rates while preserving your brand identity.",
  },
];
    ...
    <div className="min-h-screen bg-white font-[family-name:var(--font-body)]">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <GradientWord>Convert</GradientWord>
          </motion.h1>
          ...
          >
            We design and develop fast, beautiful websites that deliver
        ...
        <div className="max-w-4xl mx-auto">
          <Reveal className="text-center">
            ...
            <p className={TYPOGRAPHY.bodyLarge + " text-gray-600 leading-relaxed max-w-3xl mx-auto mb-8"}>
              If you're here looking for web development services, odds are,
              something's off with your website. Beautiful design but no traffic?
              Selling products but no one's checking out?
            </p>
              ...
              {[
                {
                  ...
                  title: "Beautiful Design, No Conversions?",
                  desc: "Your site looks great but visitors aren't taking action",
                  color: "from-red-50 to-red-100/50",
                },
                {
                  icon: <DollarSign className="w-6 h-6" />,
                  title: "Selling Products, No One's Buying?",
                  desc: "Products are listed but checkout rates are disappointing",
                  color: "from-orange-50 to-orange-100/50",
                },
                {
                  icon: <Users className="w-6 h-6" />,
                  title: "Homepage a Ghost Town?",
                  desc: "No traffic, no leads, no visibility — your site is invisible",
            ...
            <Reveal delay={200}>
              <div className="mt-10 bg-gray-50 rounded-2xl p-8 border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed italic">
                  ...
                  Most websites fail to convert because businesses focus on putting
                  their own best foot forward instead of solving the problem their
                  audience actually cares about. We lead with the solution your
                  target market needs, then show how you deliver it.
                </p>
              </div>
            </Reveal>
          </Reveal>
        ...
        <div className="max-w-6xl mx-auto">
          <Reveal className="text-center mb-16">
            ...
            <p className={TYPOGRAPHY.bodyLarge + " text-gray-600 max-w-3xl mx-auto mt-4"}>
              If your website doesn't make you look like you're the best at what you do,
              ...
              {[
                {
                  ...
                  desc: "Beautiful designs that actually convert visitors into customers.",
                },
                {
                  icon: <Code className="w-6 h-6" />,
                  title: "Fast & Scalable Development",
                  desc: "Modern code that loads fast, ranks well, and scales with you.",
                },
                {
                ...
                },
                {
                  ...
                  desc: "Built for search engines from day one.",
                },
              ].map((item, idx) => (
                <Reveal key={idx} delay={idx * 100}>
            ...
            <Reveal delay={200}>
              <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-xl">
                ...
                <div className="space-y-6">
                  {[
                    { label: "Website Sessions Increase", value: "+69%", color: "text-[#1570EF]" },
                    { label: "Engagement Increase", value: "+81%", color: "text-[#1570EF]" },
                    { label: "PageSpeed Score", value: "95+", color: "text-green-600" },
                    { label: "Conversion Rate", value: "+45%", color: "text-[#1570EF]" },
                  ].map((stat, idx) => (
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  <p className="text-sm text-gray-500 italic">
                    "A great website is the box your business comes in. It should look as premium as what's inside."
                  </p>
                </div>
              </div>
            </Reveal>
        ...
        <div className="max-w-6xl mx-auto">
          <Reveal className="text-center mb-16">
            <h2 className={TYPOGRAPHY.h2 + " text-gray-900 mb-4"}>
              What <span className="text-[#1570EF]">We Build</span>
            </h2>
      ...
      <section className="py-20 px-6 bg-gray-50/50">
        <div className="max-w-6xl mx-auto">
          <Reveal className="text-center mb-16">
            <h2 className={TYPOGRAPHY.h2 + " text-gray-900 mb-4"}>
              Our <span className="text-[#1570EF]">Tech Stack</span>
            </h2>
            <p className={TYPOGRAPHY.bodyLarge + " text-gray-600 max-w-2xl mx-auto"}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {techStack.map((stack, idx) => (
              <Reveal key={idx} delay={idx * 100}>
                <div className="bg-white rounded-2xl p-6 border border-gray-200 hover:border-[#1570EF]/20 hover:shadow-lg transition-all">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <Reveal className="text-center mb-16">
            <h2 className={TYPOGRAPHY.h2 + " text-gray-900 mb-4"}>
              Specialized <span className="text-[#1570EF]">CMS Solutions</span>
            </h2>
            <p className={TYPOGRAPHY.bodyLarge + " text-gray-600 max-w-2xl mx-auto"}>
              We excel at building with WordPress and Shopify
            </p>
          </Reveal>

          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Reveal delay={100}>
              <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200 hover:border-[#1570EF]/20 hover:shadow-lg transition-all group">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center group-hover:bg-[#1570EF] group-hover:text-white transition-colors">
                    <span className="text-blue-600 group-hover:text-white font-bold text-lg transition-colors">WP</span>
                  </div>
                  <h4 className="text-xl font-bold text-gray-900">WordPress</h4>
                </div>
                <ul className="space-y-2">
                  {["Custom Themes", "Plugin Development", "WooCommerce", "Performance", "Security"].map((item, i) => (
            ...
            <Reveal delay={200}>
              <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200 hover:border-[#1570EF]/20 hover:shadow-lg transition-all group">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center group-hover:bg-[#1570EF] group-hover:text-white transition-colors">
                    <span className="text-green-600 group-hover:text-white font-bold text-lg transition-colors">S</span>
                  </div>
                  <h4 className="text-xl font-bold text-gray-900">Shopify</h4>
                </div>
                <ul className="space-y-2">
                  {["Store Setup", "Theme Customization", "App Integration", "Payment Setup", "SEO"].map((item, i) => (
                    <li key={i} className="flex items-center gap-2 text-gray-700">
                      <Check className="w-4 h-4 text-[#1570EF]" />
                      {item}
                    </li>
      ...
      <section className="py-20 px-6 bg-gray-50/50">
        <div className="max-w-6xl mx-auto">
          <Reveal className="text-center mb-16">
            <h2 className={TYPOGRAPHY.h2 + " text-gray-900 mb-4"}>
              Why <span className="text-[#1570EF]">Choose Us</span>
            </h2>
            <p className={TYPOGRAPHY.bodyLarge + " text-gray-600 max-w-2xl mx-auto"}>
              Building websites that work for your business
            </p>
          </Reveal>
      ...
      <section className="py-20 px-6 bg-gray-50/50">
        <div className="max-w-6xl mx-auto">
          <Reveal className="text-center mb-16">
            <h2 className={TYPOGRAPHY.h2 + " text-gray-900 mb-4"}>
              Website Development <span className="text-[#1570EF]">Packages</span>
            </h2>
            <p className={TYPOGRAPHY.bodyLarge + " text-gray-600 max-w-2xl mx-auto"}>
              Conversion-focused websites built for growth
            </p>
          </Reveal>
