...
const services: Service[] = [
  { number: "01", title: "AI Automation", description: "Automate to dominate. We deploy self-learning AI agents that run your operations 24/7 so you scale without scaling headcount.", href: "#digital-marketing", cardFrom: "#3B82F6", cardTo: "#2563EB", cardText: "#FFFFFF" },
  { number: "02", title: "Web Design & Dev", description: "Conversion-first engineering meets pixel-perfect design. We build sites that load fast, look sharp, and turn visitors into revenue.", href: "#ai-automation", cardFrom: "#4F46E5", cardTo: "#4338CA", cardText: "#FFFFFF" },
  { number: "03", title: "Link Building", description: "Digital dominance starts with authority. We secure high-impact backlinks from industry leaders not directories, but real influence.", href: "#artificial-intelligence", cardFrom: "#6366F1", cardTo: "#4F46E5", cardText: "#FFFFFF" },
  { number: "04", title: "Content Writing", description: "Words that persuade, rank, and convert. Every piece is strategically crafted to build authority and drive action.", href: "#web-development", cardFrom: "#60A5FA", cardTo: "#3B82F6", cardText: "#FFFFFF" },
  { number: "05", title: "Social Media Marketing", description: "Stop posting. Start commanding. We turn your brand into a movement with scroll-stopping strategy and culture-driven content.", href: "#graphic-design", cardFrom: "#818CF8", cardTo: "#6366F1", cardText: "#FFFFFF" },
  { number: "06", title: "SEO", description: "Rank higher. Get found. We optimize for what actually matters bringing you qualified traffic, not just noise.", href: "#video-editing", cardFrom: "#4F46E5", cardTo: "#4338CA", cardText: "#FFFFFF" },
  { number: "07", title: "GEO", description: "Be the answer, not just a result. We optimize your brand for AI search engines so when users ask, you're the one they get.", href: "#video-editing", cardFrom: "#4F46E5", cardTo: "#4338CA", cardText: "#FFFFFF" },
  { number: "08", title: "Revenue Cycle Management", description: "Cash flow is king. We tighten your revenue loop from lead to payment so your business runs like a well-oiled machine.", href: "#video-editing", cardFrom: "#4F46E5", cardTo: "#4338CA", cardText: "#FFFFFF" },
];
